    ...
    <section id="home" className="relative min-h-screen pt-32 pb-20 lg:pt-12 lg:pb-10 overflow-hidden bg-white flex items-center">
      ...
      <div className="container mx-auto px-5 md:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          {/* Left Content */}
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left order-2 lg:order-2 animate-fade-in-up">
            ...
            <h1 className="text-2xl sm:text-2xl lg:text-3xl font-bold text-slate-900 leading-[1.1] tracking-tight">
                 আমরা সর্বদা আপনাদের শেখার জন্য সর্বোত্তম শিক্ষা নিশ্চিত করি   </h1>
            
            <p className="text-lg md:text-xl text-slate-500 text- leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium">
          ...
          <div className="lg:w-1/2 order-1 lg:order-1 relative w-full animate-scale-in delay-200">
            <div 
