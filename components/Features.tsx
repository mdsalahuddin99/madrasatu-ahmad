  ...
  const getTheme = (index: number) => {
    const themes = [
      { // 1. Power - Amber
        ...
        btnHover: 'group-hover:text-amber-700'
      },
      { // 2. CCTV - Violet
        ...
        btnHover: 'group-hover:text-violet-700'
      },
      { // 3. Playground - Sky
        ...
        btnHover: 'group-hover:text-sky-700'
      },
      { // 4. Residential Hall - Orange
        gradient: 'from-orange-50 to-white',
        border: 'border-orange-100',
        iconBg: 'bg-white',
        iconColor: 'text-orange-600',
        btnHover: 'group-hover:text-orange-700'
      },
      { // 5. Pure Water - Emerald
      ...
      { // 6. Security - Rose
        ...
        btnHover: 'group-hover:text-rose-700'
      }
    ];
        ...
        <div className="flex  lg:flex-row items-center gap-12 lg:gap-20 mb-20">
           ...
           <div className="lg:w-full text-center lg:text-left animate-fade-in-up">
               ...
               <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
                 শিক্ষার্থীদের জন্য <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-accent-600">আধুনিক সুযোগ-সুবিধা</span>
               </h2>
