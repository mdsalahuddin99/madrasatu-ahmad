        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white p-6 rounded-md shadow-lg border border-slate-100 flex flex-col h-full animate-fade-in-right">
            ...
            <div className="space-y-4 flex-grow">
              <div>
                <h3 className="text-xl md:text-2xl font-bold font-heading text-slate-800">মাওলানা যুবায়ের আহমাদ</h3>
                <p className="text-xs md:text-sm text-green-600 font-bold mt-1">মুহতামিম ও শায়খুল হাদীস</p>
              </div>
