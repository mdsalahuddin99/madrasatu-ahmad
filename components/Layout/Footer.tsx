...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-950 text-emerald-50 pt-20 pb-10 border-t border-emerald-800/50 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-14 h-14 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-600/30">
                <span className="text-white font-bold text-2xl font-heading">م</span>
              </div>
              <div>
                <h2 className="text-2xl font-heading font-bold text-white">মাদরাসাতু আহমাদ</h2>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-emerald-200">
                <MapPin size={18} className="mt-1 text-gold-400 flex-shrink-0" />
                <span className="text-sm">যাত্রাবাড়ী, ঢাকা, বাংলাদেশ</span>
              </li>
              <li className="flex items-start gap-3 text-emerald-200">
                <Phone size={18} className="mt-1 text-gold-400 flex-shrink-0" />
                <span className="text-sm">+৮৮০ ১৭XX-XXXXXX</span>
              </li>
              <li className="flex items-start gap-3 text-emerald-200">
                <Mail size={18} className="mt-1 text-gold-400 flex-shrink-0" />
                <span className="text-sm">info@madrasatuahmad.edu.bd</span>
              </li>
            </ul>
          </div>
        </div>
